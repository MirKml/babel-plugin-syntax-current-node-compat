...
const { getParserOptsPlugins } = require("./parserOpts");
...
if (major > 14 || (major === 14 && minor >= 3)) {
  babel7OnlyPlugins.push("syntax-top-level-await")
}
...
if (
  ...
  babel7OnlyPlugins.push("import-attributes")
}
  ...
  return {
    ...
    manipulateOptions(opts, parserOpts) {
      if (api.version.startsWith("7.")) {
        const plugins = getParserOptsPlugins(babel7OnlyPlugins);
